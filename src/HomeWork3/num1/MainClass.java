...
public class MainClass {
    public static void main(String[] args) {
        List<String> arr =  Arrays.asList
                ("Apple","Orange","Apple","Pineapple","Banana","Cherry","Kiwi","Word","Banana","Banana");

        Collections.sort(arr); //Сам массив
        System.out.println(arr);

        Set<String> uni = new HashSet<>(arr); //Уникальные слова
        System.out.println(uni);

        Iterator<String> iterator = uni.iterator(); //Кол-во слов
